...
graph LR
  ...
  :core:utils --> :core:common
  :core:utils --> :core:designsystem
  :core:utils --> :core:model
  :core:utils --> :core:test
  :core:utils --> :feature:detail
```
...
- **[DetailDataUtils](../utils/src/main/kotlin/com/waffiq/bazz_movies/core/utils/DetailDataUtils.kt)**
  - Transform meta data into readable and proper format
...
- **[TimeZoneHelper](../utils/src/main/kotlin/com/waffiq/bazz_movies/core/utils/TimeZoneHelper.kt)**
  - Helper to get device time zone.
  - It helps to test in separate object with mocking it
