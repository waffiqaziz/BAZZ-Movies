...
class SafeApiCallHelperTest {
  ...
  @Test
  fun safeApiCall_whenSuccessful_returnsResponseWithBody() =
    runTest {
  ...
  @Test
  fun safeApiCall_whenSuccessful_returnsResponseWithNullBody() =
    runTest {
      val mockResponse = mockk<Response<String>> {
        every { isSuccessful } returns true
  ...
  @Test
  fun safeApiCall_whenSuccessful_returnsResponseWithMissingCode() =
    runTest {
      val mockResponse = mockk<Response<String>> {
        every { isSuccessful } returns true
  ...
  @Test
  fun safeApiCall_whenUnsuccessful_returnsErrorWith404AndInvalidRequestMessage() =
    runTest {
      val mockResponse = mockk<Response<String>> {
        every { isSuccessful } returns false
  ...
  @Test
  fun safeApiCall_whenUnsuccessful_returnsErrorResponseWithStatusMessage() =
    runTest {
      val errorString = """
      {
          "status_code": 7,
  ...
  @Test
  fun safeApiCall_whenUnsuccessful_returnsErrorResponseWithoutStatusMessage() =
    runTest {
      val errorString = """
      {
          "status_code": 7,
  ...
  @Test
  fun safeApiCall_whenUnsuccessful_returnErrorResponseWithEmptyErrorBody() =
    runTest {
      val mockResponseBody = mockk<ResponseBody> {
  ...
  @Test
  fun safeApiCall_whenUnsuccessful_returnsErrorResponseWithNullErrorBody() =
    runTest {
      val mockResponse = mockk<Response<String>> {
        every { isSuccessful } returns false
  ...
  @Test
  fun safeApiCall_whenUnsuccessful_returnsErrorResponseWithMalformedJson() =
    runTest {
  ...
  @Test
  fun safeApiCall_whenUnsuccessful_returnsErrorResponseWithPlainTextBody() =
    runTest {
  ...
  @Test
  fun safeApiCall_whenUnsuccessful_returnNullResponse() =
    runTest {
  ...
  @Test
  fun safeApiCall_whenUnsuccessful_shouldHandleUnknownHostException() =
    runTest {
  ...
  @Test
  fun safeApiCall_whenUnsuccessful_shouldHandleSocketTimeoutException() =
    runTest {
  ...
  @Test
  fun safeApiCall_whenUnsuccessful_shouldHandleHttpException() =
    runTest {
  ...
  @Test
  fun safeApiCall__whenUnsuccessful_shouldHandleIOException() =
    runTest {
  ...
  fun safeApiCall_whenUnsuccessful_shouldHandleUnknownException() =
    runTest {
  ...
  @Test
  fun executeApiCall_whenApiCallSucceeds_emitsLoadingThenSuccess() =
    runTest {
      val mockResponse = mockk<Response<String>> {
        every { isSuccessful } returns true
  ...
  @Test
  fun executeApiCall_whenApiCallFails_emitsLoadingThenError() =
    runTest {
      val mockResponse = mockk<Response<String>> {
        every { isSuccessful } returns false
      }
  ...
  @Test
  fun executeApiCall_whenExceptionThrown_emitsLoadingThenError() =
    runTest {
