...
class MovieDataSourcePagingMovieTest : BaseMovieDataSourceTest() {
  ...
  @Test
  fun getPagingTopRatedMovies_whenSuccessful_returnsExpectedPagingData() = runTest {
  ...
  @Test
  fun getPagingPopularMovies_whenSuccessful_returnsExpectedPagingData() = runTest {
  ...
  @Test
  fun getPagingFavoriteMovies_whenSuccessful_returnsExpectedPagingData() = runTest {
    val pagingSource =
  ...
  @Test
  fun getPagingWatchlistMovies_whenSuccessful_returnsExpectedPagingData() = runTest {
    val pagingSource =
  ...
  @Test
  fun getPagingMovieRecommendation_whenSuccessful_returnsExpectedPagingData() = runTest {
    val pagingSource =
  ...
  @Test
  fun getPagingUpcomingMovies_whenSuccessful_returnsExpectedPagingData() = runTest {
  ...
  @Test
  fun getPagingPlayingNowMovies_whenSuccessful_returnsExpectedPagingData() = runTest {
