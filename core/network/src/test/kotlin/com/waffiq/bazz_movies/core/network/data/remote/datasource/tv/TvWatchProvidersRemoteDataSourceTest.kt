...
class TvWatchProvidersRemoteDataSourceTest : BaseMediaDataSourceTest() {
  ...
  @Test
  fun getTvWatchProviders_whenSuccessful_returnsExpectedResponse() = runTest {
  ...
  @Test
  fun getTvWatchProviders_whenServerError_returnsExpectedStatusMessageResponse() = runTest {
  ...
  @Test
  fun getTvWatchProviders_whenAPIRespondsWith404_returnsExpectedResponse() = runTest {
  ...
  @Test
  fun getTvWatchProviders_whenNetworkErrorOccurs_returnsExpectedResponse() = runTest {
  ...
  @Test
  fun getTvWatchProviders_whenTimeoutOccurs_returnsErrorResponse() = runTest {
  ...
  @Test
  fun getTvWatchProviders_whenHttpExceptionOccurs_returnsErrorResponse() = runTest {
  ...
  @Test
  fun getTvWatchProviders_whenIOExceptionOccurs_returnsErrorResponse() = runTest {
  ...
  @Test
  fun getTvWatchProviders_whenExceptionOccurs_returnsErrorResponse() = runTest {
