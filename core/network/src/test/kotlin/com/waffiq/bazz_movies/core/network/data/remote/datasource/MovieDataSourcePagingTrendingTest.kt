...
class MovieDataSourcePagingTrendingTest : BaseMovieDataSourceTest() {
  ...
  @Test
  fun getPagingTrendingWeek_whenSuccessful_returnsExpectedPagingData() = runTest {
  ...
  @Test
  fun getPagingTrendingDay_whenSuccessful_returnsExpectedPagingData() = runTest {
  ...
  @Test
  fun getPagingSearch_whenSuccessful_returnsExpectedPagingData() = runTest {
