...
class MovieKeywordsRemoteDataSourceTest : BaseMediaDataSourceTest() {
  ...
  @Test
  fun getMovieKeywords_whenSuccessful_returnsExpectedResponse() =
    runTest {
      testSuccessResponse(
        apiEndpoint = { mockMovieApiService.getMovieKeywords("movieId") },
        mockApiResponse = success(movieKeywordsResponse),
  ...
  @Test
  fun getMovieKeywords_whenServerError_returnsExpectedStatusMessageResponse() =
    runTest {
      testErrorResponse(
        apiEndpoint = { mockMovieApiService.getMovieKeywords("movieId") },
  ...
  @Test
  fun getMovieKeywords_whenAPIRespondsWith404_returnsExpectedResponse() =
    runTest {
  ...
  @Test
  fun getMovieKeywords_whenNetworkErrorOccurs_returnsExpectedResponse() =
    runTest {
  ...
  @Test
  fun getMovieKeywords_whenTimeoutOccurs_returnsErrorResponse() =
    runTest {
  ...
  @Test
  fun getMovieKeywords_whenHttpExceptionOccurs_returnsErrorResponse() =
    runTest {
  ...
  @Test
  fun getMovieKeywords_whenIOExceptionOccurs_returnsErrorResponse() =
    runTest {
  ...
  @Test
  fun getMovieKeywords_whenExceptionOccurs_returnsErrorResponse() =
    runTest {
