...
class TrendingDataSourceTest : BaseMediaDataSourceTest() {
  ...
  @Test
  fun getTrendingThisWeek_whenSuccessful_returnsExpectedPagingData() = runTest {
  ...
  @Test
  fun getTrendingToday_whenSuccessful_returnsExpectedPagingData() = runTest {
  ...
  @Test
  fun search_whenSuccessful_returnsExpectedPagingData() = runTest {
