...
class GenericPagingSourceTest {
  ...
  @Test
  fun loadInitialPage_whenApiCallSucceeds_returnsCorrectPage() =
    runTest {
  ...
  @Test
  fun loadPage_whenIOExceptionOccurs_returnsError() =
    runTest {
  ...
  @Test
  fun loadPage_whenHttpExceptionOccurs_returnsErrorWithMessage() =
    runTest {
  ...
  @Test
  fun loadPage_whenResponseDataIsNull_returnsNullFields() =
    runTest {
  ...
  @Test
  fun loadSubsequentPage_returnsPageWithNonNullPrevKey() =
    runTest {
  ...
  @Test
  fun loadPage_withEmptyResponse_returnsPageWithNullNextKey() =
    runTest {
