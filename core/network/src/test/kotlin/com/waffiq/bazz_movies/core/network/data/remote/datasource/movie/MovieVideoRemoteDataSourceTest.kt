...
class MovieVideoRemoteDataSourceTest : BaseMediaDataSourceTest() {
  ...
  @Test
  fun getMovieVideo_whenSuccessful_returnsExpectedResponse() =
    runTest {
      testSuccessResponse(
        apiEndpoint = { mockMovieApiService.getMovieVideo(44444) },
        mockApiResponse = success(videoMovieResponseDump),
  ...
  @Test
  fun getMovieVideo_whenServerError_returnsExpectedStatusMessageResponse() =
    runTest {
      testErrorResponse(
        apiEndpoint = { mockMovieApiService.getMovieVideo(44444) },
  ...
  @Test
  fun getMovieVideo_whenAPIRespondsWith404_returnsExpectedResponse() =
    runTest {
  ...
  @Test
  fun getMovieVideo_whenNetworkErrorOccurs_returnsExpectedResponse() =
    runTest {
  ...
  @Test
  fun getMovieVideo_whenTimeoutOccurs_returnsErrorResponse() =
    runTest {
  ...
  @Test
  fun getMovieVideo_whenHttpExceptionOccurs_returnsErrorResponse() =
    runTest {
  ...
  @Test
  fun getMovieVideo_whenIOExceptionOccurs_returnsErrorResponse() =
    runTest {
  ...
  @Test
  fun getMovieVideo_whenExceptionOccurs_returnsErrorResponse() =
    runTest {
