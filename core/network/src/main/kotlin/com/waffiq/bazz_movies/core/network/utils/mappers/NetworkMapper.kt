...
object NetworkMapper {
  ...
  fun FavoriteParams.toFavoriteRequest() = FavoriteRequest(
    mediaType = mediaType,
    mediaId = mediaId,
    favorite = favorite,
  )

  fun WatchlistParams.toWatchlistRequest() = WatchlistRequest(
    mediaType = mediaType,
    mediaId = mediaId,
    watchlist = watchlist,
  )

  fun FavoriteRequest.toUpdateFavoriteParams() = FavoriteParams(
    mediaType = mediaType,
    mediaId = mediaId,
    favorite = favorite,
  )

  fun WatchlistRequest.toUpdateWatchlistParams() = WatchlistParams(
    mediaType = mediaType,
    mediaId = mediaId,
    watchlist = watchlist,
  )
