...
class NetworkResultMapperTest {
  ...
  @Test
  fun toOutcome_withSuccessResult_returnsSuccessOutcome() =
    runTest {
  ...
  @Test
  fun toOutcome_withErrorResult_returnsErrorOutcome() =
    runTest {
  ...
  @Test
  fun toOutcome_withLoadingResult_returnsLoadingOutcome() =
    runTest {
  ...
  @Test
  fun toOutcome_withMultipleResults_returnsCorrectOutcomes() =
    runTest {
      val testData = TestData(1, "test")
