...
import com.waffiq.bazz_movies.core.data.testutils.DummyData.SESSION_ID
...
class MediaStateInteractorTest : BaseInteractorTest() {
  ...
  @Test
  fun getMovieStateWithUser_whenSuccessful_emitsSuccess() =
    runTest {
      testSuccessScenario(
  ...
  @Test
  fun getMovieStateWithUser_whenUnsuccessful_emitsError() =
    runTest {
      testErrorScenario(
        mockCall = { mockMoviesRepository.getMovieState(SESSION_ID, MOVIE_ID) },
        interactorCall = { interactor.getMovieStateWithUser(MOVIE_ID) },
  ...
  @Test
  fun getMovieStateWithUser_whenLoading_emitsLoading() =
    runTest {
      testLoadingScenario(
        mockCall = { mockMoviesRepository.getMovieState(SESSION_ID, MOVIE_ID) },
        interactorCall = { interactor.getMovieStateWithUser(MOVIE_ID) },
  ...
  @Test
  fun getTvStateWithUser_whenSuccessful_emitsSuccess() =
    runTest {
      testSuccessScenario(
  ...
  @Test
  fun getTvStateWithUser_whenUnsuccessful_emitsError() =
    runTest {
      testErrorScenario(
        mockCall = { mockTvRepository.getTvState(SESSION_ID, TV_ID) },
        interactorCall = { interactor.getTvStateWithUser(TV_ID) },
  ...
  @Test
  fun getTvStateWithUser_whenLoading_emitsLoading() =
    runTest {
      testLoadingScenario(
        mockCall = { mockTvRepository.getTvState(SESSION_ID, TV_ID) },
        interactorCall = { interactor.getTvStateWithUser(TV_ID) },
