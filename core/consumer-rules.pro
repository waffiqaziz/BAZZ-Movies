...
-keep class com.waffiq.bazz_movies.core.data.remote.responses.omdb.** { *; }
-keep class com.waffiq.bazz_movies.core.data.remote.responses.tmdb.** { *; }
-keep class com.waffiq.bazz_movies.core.data.remote.responses.countryip.** { *; }
