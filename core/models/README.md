...
`:core:models` is responsible as shared core business models and result states used throughout the
...
- Use sealed classes [`Outcome`](./src/main/kotlin/com/waffiq/bazz_movies/core/models/Outcome.kt) for **consistent state representation**.
