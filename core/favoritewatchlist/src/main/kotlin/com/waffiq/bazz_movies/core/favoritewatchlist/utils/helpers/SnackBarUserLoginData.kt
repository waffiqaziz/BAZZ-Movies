 ...
 * @param favoriteModel An optional [FavoriteModel] object containing the user's
 *                      favorite items. This can be null if no favorites are involved.
 * @param watchlistModel An optional [WatchlistModel] object containing the
...
data class SnackBarUserLoginData(
  ...
  val favoriteModel: FavoriteModel?, // optional data related to the user's favorites, may be null if not relevant
  val watchlistModel: WatchlistModel? // optional data related to the user's watchlist, may be null if not relevant
)
