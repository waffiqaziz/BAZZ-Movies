 ...
 * @param favoriteModel An optional [UpdateFavoriteParams] object containing the user's
 *                      favorite items. This can be null if no favorites are involved.
 * @param watchlistModel An optional [UpdateWatchlistParams] object containing the
...
data class SnackBarUserLoginData(
  ...
  val favoriteModel: UpdateFavoriteParams?, // optional data related to the user's favorites, may be null if not relevant
  val watchlistModel: UpdateWatchlistParams? // optional data related to the user's watchlist, may be null if not relevant
)
