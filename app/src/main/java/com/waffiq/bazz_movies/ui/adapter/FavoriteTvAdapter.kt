...
class FavoriteTvAdapter :
  PagingDataAdapter<ResultItemResponse, FavoriteTvAdapter.ViewHolder>(DIFF_CALLBACK) {
  ...
  inner class ViewHolder(private var binding: ItemMulmedBinding) :
    ...
    fun bind(resultItemResponse: ResultItemResponse) {
      ...
      binding.container.setOnClickListener {
        ...
        intent.putExtra(DetailMovieActivity.EXTRA_MOVIE, resultItemResponse.copy(mediaType = "tv"))
