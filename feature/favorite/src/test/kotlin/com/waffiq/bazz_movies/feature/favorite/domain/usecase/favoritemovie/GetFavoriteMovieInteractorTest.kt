...
import com.waffiq.bazz_movies.feature.favorite.testutils.DummyData.fakeMovieMediaItemPagingData
...
class GetFavoriteMovieInteractorTest : BaseFavoriteInteractorTest() {
  ...
  init {
    should("return favorite movies") {
      ...
      every { mockFavoriteRepository.getFavoriteMovies(any(), any(), any()) } returns flowOf(
        fakeMovieMediaItemPagingData,
      )

      testPagingFlow(interactor.getFavoriteMovies(SORT_TYPE)) { list ->
