...
class RecommendationAdapterTest : BaseAdapterTest() {
  ...
  @Test
  fun imgPoster_whenContentDescriptionAvailable_usesCorrectValue() =
    runTest {
      // all null
  ...
  private fun submitPagingAndWait(item: List<MediaItem>) =
    runTest {
  ...
  private fun submitDataYearReleased(expected: String?, item: MediaItem) =
    runTest {
