...
class GetDetailOMDbInteractorTest : BaseInteractorTest() {
  ...
  @Test
  fun getDetailOMDb_whenSuccessful_emitsSuccess() =
    runTest {
      testSuccessScenario(
  ...
  @Test
  fun getDetailOMDb_whenUnsuccessful_emitsError() =
    runTest {
      testErrorScenario(
        mockCall = { mockDetailRepository.getOMDbDetails(IMDB_ID) },
        interactorCall = { interactor.getOMDbDetails(IMDB_ID) },
  ...
  @Test
  fun getOMDbDetails_whenLoading_emitsLoading() =
    runTest {
      testLoadingScenario(
        mockCall = { mockDetailRepository.getOMDbDetails(IMDB_ID) },
        interactorCall = { interactor.getOMDbDetails(IMDB_ID) },
  ...
  @Test
  fun getTvAllScore_whenImdbEmpty_emitsError() =
    runTest {
      every { mockDetailRepository.getTvExternalIds(tmdbId) } returns
  ...
  @Test
  fun getTvAllScore_whenImdbNull_emitsError() =
    runTest {
      every { mockDetailRepository.getTvExternalIds(tmdbId) } returns
  ...
  @Test
  fun getTvAllScore_whenUnsuccessful_emitsError() =
    runTest {
      testErrorScenario(
        mockCall = { mockDetailRepository.getOMDbDetails(imdbId) },
        interactorCall = { interactor.getTvAllScore(tmdbId) },
