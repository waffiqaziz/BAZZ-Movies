...
class DetailTvViewModelTest : BaseMediaDetailViewModelTest() {
  ...
  @Test
  fun getTvDetail_whenSuccessful_emitsSuccess() =
    runTest {
  ...
  @Test
  fun getTvDetail_whenUnsuccessful_emitsError() =
    runTest {
  ...
  @Test
  fun getTvDetail_whenLoading_doesNothing() =
    runTest {
  ...
  @Test
  fun getTvCredits_whenLoading_doesNothing() =
    runTest {
  ...
  @Test
  fun getTvState_whenSuccessful_emitsSuccess() =
    runTest {
  ...
  @Test
  fun getTvState_whenUnsuccessful_emitsError() =
    runTest {
  ...
  @Test
  fun getTvState_whenLoading_doesNothing() =
    runTest {
