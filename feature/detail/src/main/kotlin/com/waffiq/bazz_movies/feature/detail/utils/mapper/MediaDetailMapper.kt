...
import com.waffiq.bazz_movies.feature.detail.utils.mapper.MediaCreditsMapper.toMediaCastItem
import com.waffiq.bazz_movies.feature.detail.utils.mapper.MediaCreditsMapper.toMediaCrewItem
...
object MediaDetailMapper {
  ...
  private fun VideoResponseItem.toVideoItem() =
    VideoItem(
      site = site,
      size = size,
      iso31661 = iso31661,
  ...
  fun GenresResponseItem.toGenresItem() =
    GenresItem(
      name = name,
      id = id,
    )

  fun SpokenLanguagesResponseItem.toSpokenLanguagesItem() =
    SpokenLanguagesItem(
      name = name,
      iso6391 = iso6391,
  ...
  fun ProductionCountriesResponseItem.toProductionCountriesItem() =
  ...
  fun ProductionCompaniesResponseItem.toProductionCompaniesItem() =
