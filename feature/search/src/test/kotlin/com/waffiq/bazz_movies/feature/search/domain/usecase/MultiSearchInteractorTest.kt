...
class MultiSearchInteractorTest {
  ...
  @Test
  fun search_whenValueIsValid_returnsDataCorrectly() =
    runTest {
      val fakePagingData =
        PagingData.from(
          listOf(
  ...
  @Test
  fun search_whenPicturePathIsNull_returnsEmptyPage() =
    runTest {
      val fakePagingData =
        PagingData.from(
          listOf(
  ...
  @Test
  fun search_whenBackdropPathIsNull_returnsDataCorrectly() =
    runTest {
      val fakePagingData =
        PagingData.from(
          listOf(
  ...
  @Test
  fun search_whenPosterPathIsNull_returnDataCorrectly() =
    runTest {
      val fakePagingData =
        PagingData.from(
          listOf(
  ...
  @Test
  fun search_whenProfilePathIsNull_returnsDataCorrectly() =
    runTest {
      val fakePagingData =
        PagingData.from(
          listOf(
  ...
  @Test
  fun search_whenBackdropPathIsValid_showsBackdrop() =
    runTest {
  ...
  @Test
  fun search_whenPosterPathIsValid_showsPoster() =
    runTest {
  ...
  @Test
  fun search_whenProfilePathIsValid_showsProfile() =
    runTest {
  ...
  @Test
  fun search_whenAllDataIsEmpty_returnsEmptyList() =
    runTest {
  ...
  @Test
  fun search_whenMixedValidValue_returnsEmptyList() =
    runTest {
  ...
  @Test
  fun search_whenMixedEmpty_returnsEmptyList() =
    runTest {
  ...
  @Test
  fun search_whenAllDataIsNull_returnsEmptyList() =
    runTest {
  ...
  @Test
  fun filter_withPathCombinations_ensureProperFilteringLogic() =
    runTest {
